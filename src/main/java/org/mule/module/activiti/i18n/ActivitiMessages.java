...
import org.mule.module.activiti.action.remote.AbstractRemoteActivitiAction;
...
public class ActivitiMessages extends MessageFactory
{
    ...
    public static Message failToExecuteAction(AbstractRemoteActivitiAction<?> action)
    {
